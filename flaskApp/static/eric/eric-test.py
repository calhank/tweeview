...
# data
hashtags = {}
total_count = {"ct": 0} ######### MY COMMENT2: Why a dict rather than an int? ###############
...
class MyStreamListener(tweepy.StreamListener):
	...
	def on_status(self, status):
		...
		######## MY COMMENT3: 
			##### 1) What about setting higher threshold than 0.0? 1b) Why set the len threshold at 500? Memory?
			##### 3) Shouldn't we be popping from recent, not global? 
...
def renderGraph(): 
	...
	if request.method == 'GET':
		...
		##### MY COMMENT5: What is this? #####
		sleep(.5)

		##### MY COMMENT6: How many tweets are sent each post?#####
		...
		recent_sentiment = recent_sentiment[-10:] #####MY COMMENT7: What is this doing here? Shouldn't it be one line above? And since we never pop from it, aren't we always averaging new sentiment with the first 10?
